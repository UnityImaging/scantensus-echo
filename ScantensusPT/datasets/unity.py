...
UnityInferSetT = namedtuple("UnityInferSetT", "image image_source unity_f_code label_height_shift label_width_shift")
...
class UnityInferSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_fn = self.image_fn_list[idx]
        image_source = self.image_source_list[idx]

        image_crop_size = self.image_crop_size
        device = self.device

        unity_o = UnityO(unity_code=image_fn, png_cache_dir=self.png_cache_dir)
